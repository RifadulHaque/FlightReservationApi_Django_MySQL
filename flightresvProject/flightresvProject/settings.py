"""
Django settings for flightresvProject project.
...
SECRET_KEY = 'django-insecure-0dg6gz6u-_*t@%o-h^*dd&ks8*(7dbxfg9&3a8d%8_-*t7b9jz'
...
ROOT_URLCONF = 'flightresvProject.urls'
...
WSGI_APPLICATION = 'flightresvProject.wsgi.application'
